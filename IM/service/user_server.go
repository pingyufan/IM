...
func CreateUser(c *gin.Context) {
	...
	exist := models.FindUserByName(user.Name)
...
func FindUserByNameAndPwd(c *gin.Context) {
	...
	exist = models.FindUserByNameAndPwd(name, pwd)
...
// 持续接收消息并通过 WebSocket 将其发送到客户端
func MsgHendler(c *gin.Context, ws *websocket.Conn) {
	for {
		msg, err := utils.Subscribe(c, utils.PublishKey)
		if err != nil {
			fmt.Println("MsgHendler 发送失败", err)
		}
